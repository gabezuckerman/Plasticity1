...
alluv <- ggplot(forAlluv,
  ...
  geom_label(stat = "stratum", 
             aes(label = after_stat(paste0(stratum, ": ", c(41, 6, 17, 41, 45, 6, 21, 33), c("\n n = 251", "\n n = 23", "\n n = 91", "\n n = 108", "", "", "", "")))), 
  ...
  geom_text(x = 1.1, y = 3, label = "4", family = "Century Gothic") +
  geom_text(x = 1.1, y = 10, label = "10", family = "Century Gothic") +
  geom_text(x = 1.1, y = 27, label = "27", family = "Century Gothic") +
  geom_text(x = 1.1, y = 43, label = "5", family = "Century Gothic") +
  geom_text(x = 1.1, y = 47, label = "1", family = "Century Gothic") +
  geom_text(x = 1.1, y = 52, label = "10", family = "Century Gothic") +
  geom_text(x = 1.1, y = 57.5, label = "1", family = "Century Gothic") +
  geom_text(x = 1.1, y = 62, label = "6", family = "Century Gothic") +
  geom_text(x = 1.1, y = 78, label = "30", family = "Century Gothic") +
  geom_text(x = 1.1, y = 94, label = "1", family = "Century Gothic") +
  geom_text(x = 1.1, y = 100, label = "10", family = "Century Gothic")
